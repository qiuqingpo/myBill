...
import com.qiuqp.mybill.bean.URLs;
...
public class ApiClient {
	...
	private static String getUserAgent(AppContext appContext) {
		if(appUserAgent == null || appUserAgent == "") {
			StringBuilder ua = new StringBuilder("265Xiaoxiao.COM");
	...
	public static Result PostQuestion(AppContext appContext,String nickNameStr,String contactType,String contactAddress,String notes, int type) throws AppException {
		Map<String,Object> params = new HashMap<String,Object>();
		params.put("nickName", nickNameStr);
		params.put("contactType", contactType);
		params.put("address", contactAddress);
		params.put("note", notes);
		params.put("type", type);		
		try{
			return Result.parse(_post(appContext, URLs.Service_Url, params, null));		
		}catch(Exception e){
			if(e instanceof AppException)
				throw (AppException)e;
			throw AppException.network(e);
